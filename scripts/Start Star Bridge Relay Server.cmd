...
if exist "%INSTALLED_SERVER%" (
    echo Starting Star Bridge Relay Server on http://127.0.0.1:5058
    ...
    "%INSTALLED_SERVER%" http://127.0.0.1:5058
    pause
    exit /b
)
...
dotnet run --project "%ROOT%\StarBridge.Server\StarBridge.Server.csproj" -- http://127.0.0.1:5058
pause
