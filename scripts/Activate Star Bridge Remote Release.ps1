param(
    ...
    [string]$DownloadUrl = "https://github.com/Domino-L/Star-Bridge/releases/download/v0.3.14/StarBridge-0.3.14-win-x64-setup.exe",
    [string]$PackageUrl = "https://github.com/Domino-L/Star-Bridge/releases/download/v0.3.14/StarBridge-0.3.14-win-x64-update.zip",
    ...
    [string]$ReleaseNotes = "StarBridge 0.3.14 update."
)
