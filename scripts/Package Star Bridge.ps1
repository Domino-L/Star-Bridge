...
$packageDir = Join-Path $distDir "StarBridge-0.3.6"
$zipPath = Join-Path $distDir "StarBridge-0.3.6-win-x64.zip"
$updateZipPath = Join-Path $distDir "StarBridge-0.3.6-win-x64-update.zip"
